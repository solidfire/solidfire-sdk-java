...
public class AddNodesResult implements Serializable {
    ...
    private static final long serialVersionUID = -1156980746L;

    @SerializedName("nodes") private final PendingNode[] nodes;
     ...
     **/
    @Since("7.0")
    public AddNodesResult(PendingNode[] nodes) {
        this.nodes = nodes;
    }
