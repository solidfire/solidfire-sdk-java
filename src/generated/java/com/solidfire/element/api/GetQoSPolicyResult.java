...
public class GetQoSPolicyResult implements Serializable {

    public static final long serialVersionUID = -4424104515730656487L;
    @SerializedName("qosPolicy") private QoSPolicy qosPolicy;

    
    // parameterized constructor
    @Since("7.0")
    public GetQoSPolicyResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        GetQoSPolicyResult that = (GetQoSPolicyResult) o;
    ...
    public static class Builder {
        ...
        public GetQoSPolicyResult build() {
            return new GetQoSPolicyResult (
                         this.qosPolicy);
        }

        private GetQoSPolicyResult.Builder buildFrom(final GetQoSPolicyResult req) {
            this.qosPolicy = req.qosPolicy;

            return this;
        }

        public GetQoSPolicyResult.Builder qosPolicy(final QoSPolicy qosPolicy) {
            this.qosPolicy = qosPolicy;
            return this;
        }
