...
public class CreateQoSPolicyResult implements Serializable {
    ...
    public static final long serialVersionUID = -7508550704777952949L;
    ...
    public boolean equals(Object o) {
        ...
        CreateQoSPolicyResult that = (CreateQoSPolicyResult) o;
    ...
    public static class Builder {
        ...
        public CreateQoSPolicyResult build() {
            return new CreateQoSPolicyResult (
                         this.qosPolicy);
        }

        private CreateQoSPolicyResult.Builder buildFrom(final CreateQoSPolicyResult req) {
            this.qosPolicy = req.qosPolicy;

            return this;
        }

        public CreateQoSPolicyResult.Builder qosPolicy(final QoSPolicy qosPolicy) {
            this.qosPolicy = qosPolicy;
            return this;
        }
