...
public class UpdateIdpConfigurationResult implements Serializable {

    public static final long serialVersionUID = -6435449545986993391L;
    @SerializedName("idpConfigInfo") private IdpConfigInfo idpConfigInfo;
    // empty constructor
    @Since("7.0")
    public UpdateIdpConfigurationResult() {}
    ...
    public boolean equals(Object o) {
        ...
        UpdateIdpConfigurationResult that = (UpdateIdpConfigurationResult) o;
    ...
    public static class Builder {
        ...
        public UpdateIdpConfigurationResult build() {
            return new UpdateIdpConfigurationResult (
                         this.idpConfigInfo);
        }

        private UpdateIdpConfigurationResult.Builder buildFrom(final UpdateIdpConfigurationResult req) {
            this.idpConfigInfo = req.idpConfigInfo;

            return this;
        }

        public UpdateIdpConfigurationResult.Builder idpConfigInfo(final IdpConfigInfo idpConfigInfo) {
            this.idpConfigInfo = idpConfigInfo;
            return this;
        }
