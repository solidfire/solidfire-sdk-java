...
public class QuiesceSnapMirrorRelationshipResult implements Serializable {
    ...
    @Since("7.0")
    public QuiesceSnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        QuiesceSnapMirrorRelationshipResult that = (QuiesceSnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public QuiesceSnapMirrorRelationshipResult build() {
            return new QuiesceSnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private QuiesceSnapMirrorRelationshipResult.Builder buildFrom(final QuiesceSnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public QuiesceSnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
