...
public class ModifySnapMirrorRelationshipResult implements Serializable {
    ...
    @Since("7.0")
    public ModifySnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        ModifySnapMirrorRelationshipResult that = (ModifySnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public ModifySnapMirrorRelationshipResult build() {
            return new ModifySnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private ModifySnapMirrorRelationshipResult.Builder buildFrom(final ModifySnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public ModifySnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
