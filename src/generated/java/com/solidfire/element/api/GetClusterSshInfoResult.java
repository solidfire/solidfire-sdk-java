...
public class GetClusterSshInfoResult implements Serializable {

    public static final long serialVersionUID = -5760944074713437824L;
    ...
    @Since("7.0")
    public GetClusterSshInfoResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        GetClusterSshInfoResult that = (GetClusterSshInfoResult) o;
    ...
    public static class Builder {
        ...
        public GetClusterSshInfoResult build() {
            return new GetClusterSshInfoResult (
                         this.enabled,
                         this.timeRemaining,
                         this.nodes);
        }

        private GetClusterSshInfoResult.Builder buildFrom(final GetClusterSshInfoResult req) {
        ...
        public GetClusterSshInfoResult.Builder enabled(final Boolean enabled) {
            this.enabled = enabled;
            return this;
        }

        public GetClusterSshInfoResult.Builder timeRemaining(final String timeRemaining) {
            this.timeRemaining = timeRemaining;
            return this;
        }

        public GetClusterSshInfoResult.Builder nodes(final NodeSshInfo[] nodes) {
            this.nodes = nodes;
            return this;
        }
