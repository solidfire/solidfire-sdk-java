...
public class DeleteKeyServerKmipRequest implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DeleteKeyServerKmipRequest that = (DeleteKeyServerKmipRequest) o;
    ...
    public static class Builder {
        ...
        public DeleteKeyServerKmipRequest build() {
            return new DeleteKeyServerKmipRequest (
                         this.keyServerID);
        }

        private DeleteKeyServerKmipRequest.Builder buildFrom(final DeleteKeyServerKmipRequest req) {
            this.keyServerID = req.keyServerID;

            return this;
        }

        public DeleteKeyServerKmipRequest.Builder keyServerID(final Long keyServerID) {
            this.keyServerID = keyServerID;
            return this;
        }
