...
public class ResumeSnapMirrorRelationshipResult implements Serializable {

    public static final long serialVersionUID = 2229415386120950778L;
    @SerializedName("snapMirrorRelationship") private SnapMirrorRelationship snapMirrorRelationship;

    
    // parameterized constructor
    @Since("7.0")
    public ResumeSnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        ResumeSnapMirrorRelationshipResult that = (ResumeSnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public ResumeSnapMirrorRelationshipResult build() {
            return new ResumeSnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private ResumeSnapMirrorRelationshipResult.Builder buildFrom(final ResumeSnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public ResumeSnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
