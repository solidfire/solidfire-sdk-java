...
public class NodeSystemStatusInfo implements Serializable {

    public static final long serialVersionUID = -3140912543141360227L;
    ...
    public boolean equals(Object o) {
        ...
        NodeSystemStatusInfo that = (NodeSystemStatusInfo) o;
    ...
    public static class Builder {
        ...
        public NodeSystemStatusInfo build() {
            return new NodeSystemStatusInfo (
                         this.rebootRequired);
        }

        private NodeSystemStatusInfo.Builder buildFrom(final NodeSystemStatusInfo req) {
            this.rebootRequired = req.rebootRequired;

            return this;
        }

        public NodeSystemStatusInfo.Builder rebootRequired(final Boolean rebootRequired) {
            this.rebootRequired = rebootRequired;
            return this;
        }
