...
public class ResetNodeSupplementalTlsCiphersResult implements Serializable {
    ...
    public static final long serialVersionUID = 8100522364989702920L;
    ...
    public boolean equals(Object o) {
        ...
        ResetNodeSupplementalTlsCiphersResult that = (ResetNodeSupplementalTlsCiphersResult) o;
    ...
    public static class Builder {
        ...
        public ResetNodeSupplementalTlsCiphersResult build() {
            return new ResetNodeSupplementalTlsCiphersResult (
                         this.mandatoryCiphers,
                         this.supplementalCiphers);
        }

        private ResetNodeSupplementalTlsCiphersResult.Builder buildFrom(final ResetNodeSupplementalTlsCiphersResult req) {
        ...
        public ResetNodeSupplementalTlsCiphersResult.Builder mandatoryCiphers(final String[] mandatoryCiphers) {
            this.mandatoryCiphers = mandatoryCiphers;
            return this;
        }

        public ResetNodeSupplementalTlsCiphersResult.Builder supplementalCiphers(final String[] supplementalCiphers) {
            this.supplementalCiphers = supplementalCiphers;
            return this;
        }
