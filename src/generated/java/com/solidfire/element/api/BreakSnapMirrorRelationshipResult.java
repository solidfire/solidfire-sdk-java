...
public class BreakSnapMirrorRelationshipResult implements Serializable {

    public static final long serialVersionUID = 6097448342542870742L;
    @SerializedName("snapMirrorRelationship") private SnapMirrorRelationship snapMirrorRelationship;

    
    // parameterized constructor
    @Since("7.0")
    public BreakSnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        BreakSnapMirrorRelationshipResult that = (BreakSnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public BreakSnapMirrorRelationshipResult build() {
            return new BreakSnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private BreakSnapMirrorRelationshipResult.Builder buildFrom(final BreakSnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public BreakSnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
