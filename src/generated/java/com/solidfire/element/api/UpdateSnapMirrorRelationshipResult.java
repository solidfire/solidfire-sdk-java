...
public class UpdateSnapMirrorRelationshipResult implements Serializable {

    public static final long serialVersionUID = -1850156984520894032L;
    @SerializedName("snapMirrorRelationship") private SnapMirrorRelationship snapMirrorRelationship;

    
    // parameterized constructor
    @Since("7.0")
    public UpdateSnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        UpdateSnapMirrorRelationshipResult that = (UpdateSnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public UpdateSnapMirrorRelationshipResult build() {
            return new UpdateSnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private UpdateSnapMirrorRelationshipResult.Builder buildFrom(final UpdateSnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public UpdateSnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
