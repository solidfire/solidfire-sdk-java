...
public class TestKeyProviderKmipRequest implements Serializable {

    public static final long serialVersionUID = 8872213903948131199L;
    @SerializedName("keyProviderID") private Long keyProviderID;
    // empty constructor
    @Since("7.0")
    public TestKeyProviderKmipRequest() {}
    ...
    public boolean equals(Object o) {
        ...
        TestKeyProviderKmipRequest that = (TestKeyProviderKmipRequest) o;
    ...
    public static class Builder {
        ...
        public TestKeyProviderKmipRequest build() {
            return new TestKeyProviderKmipRequest (
                         this.keyProviderID);
        }

        private TestKeyProviderKmipRequest.Builder buildFrom(final TestKeyProviderKmipRequest req) {
            this.keyProviderID = req.keyProviderID;

            return this;
        }

        public TestKeyProviderKmipRequest.Builder keyProviderID(final Long keyProviderID) {
            this.keyProviderID = keyProviderID;
            return this;
        }
