...
public class GetSSLCertificateResult implements Serializable {

    public static final long serialVersionUID = 4553165039665225289L;
    ...
    @Since("7.0")
    public GetSSLCertificateResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        GetSSLCertificateResult that = (GetSSLCertificateResult) o;
    ...
    public static class Builder {
        ...
        public GetSSLCertificateResult build() {
            return new GetSSLCertificateResult (
                         this.certificate,
                         this.details);
        }

        private GetSSLCertificateResult.Builder buildFrom(final GetSSLCertificateResult req) {
        ...
        public GetSSLCertificateResult.Builder certificate(final String certificate) {
            this.certificate = certificate;
            return this;
        }

        public GetSSLCertificateResult.Builder details(final Attributes details) {
            this.details = details;
            return this;
        }
