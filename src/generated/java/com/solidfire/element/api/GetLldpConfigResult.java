...
public class GetLldpConfigResult implements Serializable {

    public static final long serialVersionUID = 7594968916058185495L;
    @SerializedName("lldpConfig") private LldpConfig lldpConfig;

    
    // parameterized constructor
    @Since("7.0")
    public GetLldpConfigResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        GetLldpConfigResult that = (GetLldpConfigResult) o;
    ...
    public static class Builder {
        ...
        public GetLldpConfigResult build() {
            return new GetLldpConfigResult (
                         this.lldpConfig);
        }

        private GetLldpConfigResult.Builder buildFrom(final GetLldpConfigResult req) {
            this.lldpConfig = req.lldpConfig;

            return this;
        }

        public GetLldpConfigResult.Builder lldpConfig(final LldpConfig lldpConfig) {
            this.lldpConfig = lldpConfig;
            return this;
        }
