...
public class ResumeSnapMirrorRelationshipRequest implements Serializable {

    public static final long serialVersionUID = 8799317078709378507L;
    ...
    @Since("7.0")
    public ResumeSnapMirrorRelationshipRequest(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        ResumeSnapMirrorRelationshipRequest that = (ResumeSnapMirrorRelationshipRequest) o;
    ...
    public static class Builder {
        ...
        public ResumeSnapMirrorRelationshipRequest build() {
            return new ResumeSnapMirrorRelationshipRequest (
                         this.snapMirrorEndpointID,
                         this.destinationVolume);
        }

        private ResumeSnapMirrorRelationshipRequest.Builder buildFrom(final ResumeSnapMirrorRelationshipRequest req) {
        ...
        public ResumeSnapMirrorRelationshipRequest.Builder snapMirrorEndpointID(final Long snapMirrorEndpointID) {
            this.snapMirrorEndpointID = snapMirrorEndpointID;
            return this;
        }

        public ResumeSnapMirrorRelationshipRequest.Builder destinationVolume(final SnapMirrorVolumeInfo destinationVolume) {
            this.destinationVolume = destinationVolume;
            return this;
        }
