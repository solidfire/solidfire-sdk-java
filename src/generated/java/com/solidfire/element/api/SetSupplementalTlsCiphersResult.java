...
public class SetSupplementalTlsCiphersResult implements Serializable {
    ...
    // empty constructor
    @Since("7.0")
    public SetSupplementalTlsCiphersResult() {}
    ...
    public boolean equals(Object o) {
        ...
        SetSupplementalTlsCiphersResult that = (SetSupplementalTlsCiphersResult) o;
    ...
    public static class Builder {
        ...
        public SetSupplementalTlsCiphersResult build() {
            return new SetSupplementalTlsCiphersResult (
                         this.mandatoryCiphers,
                         this.supplementalCiphers);
        }

        private SetSupplementalTlsCiphersResult.Builder buildFrom(final SetSupplementalTlsCiphersResult req) {
        ...
        public SetSupplementalTlsCiphersResult.Builder mandatoryCiphers(final String[] mandatoryCiphers) {
            this.mandatoryCiphers = mandatoryCiphers;
            return this;
        }

        public SetSupplementalTlsCiphersResult.Builder supplementalCiphers(final String[] supplementalCiphers) {
            this.supplementalCiphers = supplementalCiphers;
            return this;
        }
