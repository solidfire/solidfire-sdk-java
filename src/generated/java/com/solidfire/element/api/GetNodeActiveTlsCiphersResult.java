...
public class GetNodeActiveTlsCiphersResult implements Serializable {

    public static final long serialVersionUID = 3184050127780843306L;
    ...
    // empty constructor
    @Since("7.0")
    public GetNodeActiveTlsCiphersResult() {}
    ...
    public boolean equals(Object o) {
        ...
        GetNodeActiveTlsCiphersResult that = (GetNodeActiveTlsCiphersResult) o;
    ...
    public static class Builder {
        ...
        public GetNodeActiveTlsCiphersResult build() {
            return new GetNodeActiveTlsCiphersResult (
                         this.mandatoryCiphers,
                         this.supplementalCiphers);
        }

        private GetNodeActiveTlsCiphersResult.Builder buildFrom(final GetNodeActiveTlsCiphersResult req) {
        ...
        public GetNodeActiveTlsCiphersResult.Builder mandatoryCiphers(final String[] mandatoryCiphers) {
            this.mandatoryCiphers = mandatoryCiphers;
            return this;
        }

        public GetNodeActiveTlsCiphersResult.Builder supplementalCiphers(final String[] supplementalCiphers) {
            this.supplementalCiphers = supplementalCiphers;
            return this;
        }
