...
public class SetLoginBannerResult implements Serializable {

    public static final long serialVersionUID = 6952066117302632110L;
    @SerializedName("loginBanner") private LoginBanner loginBanner;

    
    // parameterized constructor
    @Since("7.0")
    public SetLoginBannerResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        SetLoginBannerResult that = (SetLoginBannerResult) o;
    ...
    public static class Builder {
        ...
        public SetLoginBannerResult build() {
            return new SetLoginBannerResult (
                         this.loginBanner);
        }

        private SetLoginBannerResult.Builder buildFrom(final SetLoginBannerResult req) {
            this.loginBanner = req.loginBanner;

            return this;
        }

        public SetLoginBannerResult.Builder loginBanner(final LoginBanner loginBanner) {
            this.loginBanner = loginBanner;
            return this;
        }
