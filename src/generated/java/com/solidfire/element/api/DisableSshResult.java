...
public class DisableSshResult implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DisableSshResult that = (DisableSshResult) o;
    ...
    public static class Builder {
        ...
        public DisableSshResult build() {
            return new DisableSshResult (
                         this.enabled);
        }

        private DisableSshResult.Builder buildFrom(final DisableSshResult req) {
            this.enabled = req.enabled;

            return this;
        }

        public DisableSshResult.Builder enabled(final Boolean enabled) {
            this.enabled = enabled;
            return this;
        }
