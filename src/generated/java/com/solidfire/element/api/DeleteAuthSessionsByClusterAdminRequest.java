...
public class DeleteAuthSessionsByClusterAdminRequest implements Serializable {
    ...
    // empty constructor
    @Since("7.0")
    public DeleteAuthSessionsByClusterAdminRequest() {}
    ...
    public boolean equals(Object o) {
        ...
        DeleteAuthSessionsByClusterAdminRequest that = (DeleteAuthSessionsByClusterAdminRequest) o;
    ...
    public static class Builder {
        ...
        public DeleteAuthSessionsByClusterAdminRequest build() {
            return new DeleteAuthSessionsByClusterAdminRequest (
                         this.clusterAdminID);
        }

        private DeleteAuthSessionsByClusterAdminRequest.Builder buildFrom(final DeleteAuthSessionsByClusterAdminRequest req) {
            this.clusterAdminID = req.clusterAdminID;

            return this;
        }

        public DeleteAuthSessionsByClusterAdminRequest.Builder clusterAdminID(final Long clusterAdminID) {
            this.clusterAdminID = clusterAdminID;
            return this;
        }
