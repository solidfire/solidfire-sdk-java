...
public class SetSnmpTrapInfoRequest implements Serializable {
    ...
    public static final long serialVersionUID = 4903783197412432501L;
    @SerializedName("trapRecipients") private Optional<SnmpTrapRecipient[]> trapRecipients;
    ...
    {
        this.trapRecipients = (trapRecipients == null) ? Optional.<SnmpTrapRecipient[]>empty() : trapRecipients;
     ...
     **/
    public Optional<SnmpTrapRecipient[]> getTrapRecipients() { return this.trapRecipients; }
    ...
    public String toString() {
        ...
        if(null != trapRecipients && trapRecipients.isPresent()){
            sb.append(" trapRecipients : ").append(gson.toJson(trapRecipients)).append(",");
        }
        else{
    ...
    public static class Builder {
        ...
        public SetSnmpTrapInfoRequest.Builder optionalTrapRecipients(final SnmpTrapRecipient[] trapRecipients) {
            this.trapRecipients = (trapRecipients == null) ? Optional.<SnmpTrapRecipient[]>empty() : Optional.of(trapRecipients);
            return this;
        }
