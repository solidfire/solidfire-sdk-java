...
public class ListSnapMirrorSchedulesRequest implements Serializable {

    public static final long serialVersionUID = -2922411656274811305L;
    @SerializedName("snapMirrorEndpointID") private Optional<Long> snapMirrorEndpointID;

    
    // parameterized constructor
    @Since("7.0")
    public ListSnapMirrorSchedulesRequest(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        ListSnapMirrorSchedulesRequest that = (ListSnapMirrorSchedulesRequest) o;
    ...
    public static class Builder {
        ...
        public ListSnapMirrorSchedulesRequest build() {
            return new ListSnapMirrorSchedulesRequest (
                         this.snapMirrorEndpointID);
        }

        private ListSnapMirrorSchedulesRequest.Builder buildFrom(final ListSnapMirrorSchedulesRequest req) {
            this.snapMirrorEndpointID = req.snapMirrorEndpointID;

            return this;
        }

        public ListSnapMirrorSchedulesRequest.Builder optionalSnapMirrorEndpointID(final Long snapMirrorEndpointID) {
