...
public class GetSupportedTlsCiphersResult implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        GetSupportedTlsCiphersResult that = (GetSupportedTlsCiphersResult) o;
    ...
    public static class Builder {
        ...
        public GetSupportedTlsCiphersResult build() {
            return new GetSupportedTlsCiphersResult (
                         this.mandatoryCiphers,
                         this.defaultSupplementalCiphers,
                         this.supportedSupplementalCiphers);
        }

        private GetSupportedTlsCiphersResult.Builder buildFrom(final GetSupportedTlsCiphersResult req) {
        ...
        public GetSupportedTlsCiphersResult.Builder mandatoryCiphers(final String[] mandatoryCiphers) {
            this.mandatoryCiphers = mandatoryCiphers;
            return this;
        }

        public GetSupportedTlsCiphersResult.Builder defaultSupplementalCiphers(final String[] defaultSupplementalCiphers) {
            this.defaultSupplementalCiphers = defaultSupplementalCiphers;
            return this;
        }

        public GetSupportedTlsCiphersResult.Builder supportedSupplementalCiphers(final String[] supportedSupplementalCiphers) {
            this.supportedSupplementalCiphers = supportedSupplementalCiphers;
            return this;
        }
