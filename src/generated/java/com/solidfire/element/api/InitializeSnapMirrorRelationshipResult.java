...
public class InitializeSnapMirrorRelationshipResult implements Serializable {

    public static final long serialVersionUID = 7838887061312338255L;
    @SerializedName("snapMirrorRelationship") private SnapMirrorRelationship snapMirrorRelationship;

    
    // parameterized constructor
    @Since("7.0")
    public InitializeSnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        InitializeSnapMirrorRelationshipResult that = (InitializeSnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public InitializeSnapMirrorRelationshipResult build() {
            return new InitializeSnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private InitializeSnapMirrorRelationshipResult.Builder buildFrom(final InitializeSnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public InitializeSnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
