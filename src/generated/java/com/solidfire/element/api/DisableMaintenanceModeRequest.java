...
public class DisableMaintenanceModeRequest implements Serializable {
    ...
    // empty constructor
    @Since("7.0")
    public DisableMaintenanceModeRequest() {}
    ...
    public boolean equals(Object o) {
        ...
        DisableMaintenanceModeRequest that = (DisableMaintenanceModeRequest) o;
    ...
    public static class Builder {
        ...
        public DisableMaintenanceModeRequest build() {
            return new DisableMaintenanceModeRequest (
                         this.nodes);
        }

        private DisableMaintenanceModeRequest.Builder buildFrom(final DisableMaintenanceModeRequest req) {
            this.nodes = req.nodes;

            return this;
        }

        public DisableMaintenanceModeRequest.Builder nodes(final Long[] nodes) {
            this.nodes = nodes;
            return this;
        }
