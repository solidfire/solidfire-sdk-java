...
public class SetSSLCertificateRequest implements Serializable {
    ...
    public static final long serialVersionUID = -2779423384740713143L;
    ...
    public boolean equals(Object o) {
        ...
        SetSSLCertificateRequest that = (SetSSLCertificateRequest) o;
    ...
    public static class Builder {
        ...
        public SetSSLCertificateRequest build() {
            return new SetSSLCertificateRequest (
                         this.certificate,
                         this.privateKey);
        }

        private SetSSLCertificateRequest.Builder buildFrom(final SetSSLCertificateRequest req) {
        ...
        public SetSSLCertificateRequest.Builder certificate(final String certificate) {
            this.certificate = certificate;
            return this;
        }

        public SetSSLCertificateRequest.Builder privateKey(final String privateKey) {
            this.privateKey = privateKey;
            return this;
        }
