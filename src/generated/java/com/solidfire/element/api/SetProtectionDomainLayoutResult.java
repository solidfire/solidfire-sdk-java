...
public class SetProtectionDomainLayoutResult implements Serializable {
    ...
    public static final long serialVersionUID = 7803987676081401398L;
    ...
    public boolean equals(Object o) {
        ...
        SetProtectionDomainLayoutResult that = (SetProtectionDomainLayoutResult) o;
    ...
    public static class Builder {
        ...
        public SetProtectionDomainLayoutResult build() {
            return new SetProtectionDomainLayoutResult (
                         this.protectionDomainLayout);
        }

        private SetProtectionDomainLayoutResult.Builder buildFrom(final SetProtectionDomainLayoutResult req) {
            this.protectionDomainLayout = req.protectionDomainLayout;

            return this;
        }

        public SetProtectionDomainLayoutResult.Builder protectionDomainLayout(final NodeProtectionDomains[] protectionDomainLayout) {
            this.protectionDomainLayout = protectionDomainLayout;
            return this;
        }
