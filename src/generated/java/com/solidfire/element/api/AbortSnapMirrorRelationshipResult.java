...
public class AbortSnapMirrorRelationshipResult implements Serializable {

    public static final long serialVersionUID = 5268614482559601147L;
    @SerializedName("snapMirrorRelationship") private SnapMirrorRelationship snapMirrorRelationship;

    
    // parameterized constructor
    @Since("7.0")
    public AbortSnapMirrorRelationshipResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        AbortSnapMirrorRelationshipResult that = (AbortSnapMirrorRelationshipResult) o;
    ...
    public static class Builder {
        ...
        public AbortSnapMirrorRelationshipResult build() {
            return new AbortSnapMirrorRelationshipResult (
                         this.snapMirrorRelationship);
        }

        private AbortSnapMirrorRelationshipResult.Builder buildFrom(final AbortSnapMirrorRelationshipResult req) {
            this.snapMirrorRelationship = req.snapMirrorRelationship;

            return this;
        }

        public AbortSnapMirrorRelationshipResult.Builder snapMirrorRelationship(final SnapMirrorRelationship snapMirrorRelationship) {
            this.snapMirrorRelationship = snapMirrorRelationship;
            return this;
        }
