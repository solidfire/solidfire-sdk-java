...
public class ModifyInitiatorsResult implements Serializable {

    public static final long serialVersionUID = 3912911760263301375L;
    ...
    public boolean equals(Object o) {
        ...
        ModifyInitiatorsResult that = (ModifyInitiatorsResult) o;
    ...
    public static class Builder {
        ...
        public ModifyInitiatorsResult build() {
            return new ModifyInitiatorsResult (
                         this.initiators);
        }

        private ModifyInitiatorsResult.Builder buildFrom(final ModifyInitiatorsResult req) {
            this.initiators = req.initiators;

            return this;
        }

        public ModifyInitiatorsResult.Builder initiators(final Initiator[] initiators) {
            this.initiators = initiators;
            return this;
        }
