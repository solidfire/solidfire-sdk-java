...
public class GetActiveTlsCiphersResult implements Serializable {

    public static final long serialVersionUID = -8499041570118442622L;
    ...
    // empty constructor
    @Since("7.0")
    public GetActiveTlsCiphersResult() {}
    ...
    public boolean equals(Object o) {
        ...
        GetActiveTlsCiphersResult that = (GetActiveTlsCiphersResult) o;
    ...
    public static class Builder {
        ...
        public GetActiveTlsCiphersResult build() {
            return new GetActiveTlsCiphersResult (
                         this.mandatoryCiphers,
                         this.supplementalCiphers);
        }

        private GetActiveTlsCiphersResult.Builder buildFrom(final GetActiveTlsCiphersResult req) {
        ...
        public GetActiveTlsCiphersResult.Builder mandatoryCiphers(final String[] mandatoryCiphers) {
            this.mandatoryCiphers = mandatoryCiphers;
            return this;
        }

        public GetActiveTlsCiphersResult.Builder supplementalCiphers(final String[] supplementalCiphers) {
            this.supplementalCiphers = supplementalCiphers;
            return this;
        }
