...
public class CreateSnapMirrorEndpointResult implements Serializable {
    ...
    public static final long serialVersionUID = -3322176691974159882L;
    ...
    public boolean equals(Object o) {
        ...
        CreateSnapMirrorEndpointResult that = (CreateSnapMirrorEndpointResult) o;
    ...
    public static class Builder {
        ...
        public CreateSnapMirrorEndpointResult build() {
            return new CreateSnapMirrorEndpointResult (
                         this.snapMirrorEndpoint);
        }

        private CreateSnapMirrorEndpointResult.Builder buildFrom(final CreateSnapMirrorEndpointResult req) {
            this.snapMirrorEndpoint = req.snapMirrorEndpoint;

            return this;
        }

        public CreateSnapMirrorEndpointResult.Builder snapMirrorEndpoint(final SnapMirrorEndpoint snapMirrorEndpoint) {
            this.snapMirrorEndpoint = snapMirrorEndpoint;
            return this;
        }
