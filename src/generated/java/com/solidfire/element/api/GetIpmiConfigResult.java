...
public class GetIpmiConfigResult implements Serializable {
    ...
    public static final long serialVersionUID = 8448297441105775508L;
    ...
    public static class Builder {
        ...
        public GetIpmiConfigResult build() {
            return new GetIpmiConfigResult (
                         this.nodes);
        }

        private GetIpmiConfigResult.Builder buildFrom(final GetIpmiConfigResult req) {
