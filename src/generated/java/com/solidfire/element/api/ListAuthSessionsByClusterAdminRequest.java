...
public class ListAuthSessionsByClusterAdminRequest implements Serializable {
    ...
    // empty constructor
    @Since("7.0")
    public ListAuthSessionsByClusterAdminRequest() {}
    ...
    public boolean equals(Object o) {
        ...
        ListAuthSessionsByClusterAdminRequest that = (ListAuthSessionsByClusterAdminRequest) o;
    ...
    public static class Builder {
        ...
        public ListAuthSessionsByClusterAdminRequest build() {
            return new ListAuthSessionsByClusterAdminRequest (
                         this.clusterAdminID);
        }

        private ListAuthSessionsByClusterAdminRequest.Builder buildFrom(final ListAuthSessionsByClusterAdminRequest req) {
            this.clusterAdminID = req.clusterAdminID;

            return this;
        }

        public ListAuthSessionsByClusterAdminRequest.Builder clusterAdminID(final Long clusterAdminID) {
            this.clusterAdminID = clusterAdminID;
            return this;
        }
