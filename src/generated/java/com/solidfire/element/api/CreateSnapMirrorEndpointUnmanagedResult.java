...
public class CreateSnapMirrorEndpointUnmanagedResult implements Serializable {

    public static final long serialVersionUID = -1638542376166957618L;
    @SerializedName("snapMirrorEndpoint") private SnapMirrorEndpoint snapMirrorEndpoint;

    
    // parameterized constructor
    @Since("7.0")
    public CreateSnapMirrorEndpointUnmanagedResult(
    )
    {
    }
    // parameterized constructor
    ...
    public boolean equals(Object o) {
        ...
        CreateSnapMirrorEndpointUnmanagedResult that = (CreateSnapMirrorEndpointUnmanagedResult) o;
    ...
    public static class Builder {
        ...
        public CreateSnapMirrorEndpointUnmanagedResult build() {
            return new CreateSnapMirrorEndpointUnmanagedResult (
                         this.snapMirrorEndpoint);
        }

        private CreateSnapMirrorEndpointUnmanagedResult.Builder buildFrom(final CreateSnapMirrorEndpointUnmanagedResult req) {
            this.snapMirrorEndpoint = req.snapMirrorEndpoint;

            return this;
        }

        public CreateSnapMirrorEndpointUnmanagedResult.Builder snapMirrorEndpoint(final SnapMirrorEndpoint snapMirrorEndpoint) {
            this.snapMirrorEndpoint = snapMirrorEndpoint;
            return this;
        }
