...
public class EnableClusterSshResult implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        EnableClusterSshResult that = (EnableClusterSshResult) o;
    ...
    public static class Builder {
        ...
        public EnableClusterSshResult build() {
            return new EnableClusterSshResult (
                         this.enabled,
                         this.timeRemaining,
                         this.nodes);
        }

        private EnableClusterSshResult.Builder buildFrom(final EnableClusterSshResult req) {
        ...
        public EnableClusterSshResult.Builder enabled(final Boolean enabled) {
            this.enabled = enabled;
            return this;
        }

        public EnableClusterSshResult.Builder timeRemaining(final String timeRemaining) {
            this.timeRemaining = timeRemaining;
            return this;
        }

        public EnableClusterSshResult.Builder nodes(final NodeSshInfo[] nodes) {
            this.nodes = nodes;
            return this;
        }
